            ...
            h.Widget.call(this, g, j, !0),
                ...
                eb._generateContent = function() {
                    ...
                    return a.each(R.wheels,
                        function(f, g) {
                            c += '<div class="mbsc-w-p dwc' + ("scroller" != R.mode ? " dwpm": " dwsc") + (R.showLabel ? "": " dwhl") + '"><div class="dwwc"' + (R.maxWidth ? "": ' style="max-width:100%;"') + ">" + (m ? "": '<table class="dw-tbl" cellpadding="0" cellspacing="0"><tr>'),
                                a.each(g,
                                    function(a, f) {
                                        jb[e] = f,
    ...
    function(a, b) {
        var c = a.mobiscroll,
            ...
            e = function(c) {
                ...
                // s.showInput && (p = a('input').insertBefore(w), s.anchor = p, c.attachShow(p)),
