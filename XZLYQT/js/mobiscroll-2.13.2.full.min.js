        ...
        h.Scroller = function(g, j, q) {
            ...
            function t(b) {
                if (f) {
                    ...
                    if (b.stopPropagation(), l && 300 > h ? (d = (Y - W) / h, e = d * d / R.speedUnit, 0 > Y - W && (e = -e)) : e = Y - W, g = Math.round(Z - e / Q), !V) {
                        //获取点击了第几个 Q为每个的高度  Y为单个行高
                        Q = document.body.clientWidth/Q ;
                        var k = Math.floor((Y - j) / Q),// k是选择的值
                ...
                return a.each(i,
                    function(a, b) {
                        g % 20 === 0 && (c += '</div><div class="dw-bf">'),
                            c += '<div role="option" aria-selected="false" class="dw-li dw-v" data-val="' + j[a] + '"' + (h[a] ? ' aria-label="' + h[a] + '"': "") + ' style="height:' + Q + "vw;line-height:" + Q + 'vw;"><div class="dw-i"' + (cb > 1 ? ' style="line-height:' + Math.round(Q / cb) + "vw;font-size:" + Math.round(Q / cb * .8) + 'vw;"': "") + ">" + b + "</div></div>",
                            g++
                        console.log("---19---");
                    }),
                    c += "</div>"
            ...
            function E(c) {
                ...
                return l ? (a.each(["t", "webkitT", "MozT", "OT", "msT"],
                    ...
                    }), e = e.split(")")[0].split(", "), f = e[13] || e[5]) : f = g.top.replace("vw", ""),
                    Math.round( - f / Q)
                console.log("------Q-----");
            }
            function F(a, b) {
            ...
            function G(a, b, c, d, e) {
                ...
                var f = -c * Q  ,
                    g = a[0].style;
                console.log("第几项"+ c);  //第几项
                console.log("每一项的高度"+ Q);   //每一项的高度
                console.log("距离"+ f);  //第几项
                f == ib[b] && gb[b] || (ib[b] = f, g[k + "Transition"] = "all " + (d ? d.toFixed(3) : 0) + "s ease-out", l ? g[k + "Transform"] = "translate3d(0," + f + "vw,0)": g.top = f + "vw", gb[b] && F(a, b), d && e && (a.closest(".dwwl").addClass("dwa"), gb[b] = setTimeout(function() {
                        F(a, b)
                        console.log(b)
                    },
                    1e3 * d)), hb[b] = c)
                                ...
                                a.each(g,
                                    function(a, f) {
                                        jb[e] = f,
                                            ...
                                            c += "<" + (m ? "div": "td") + ' class="dwfl" style="' + (R.fixedWidth ? "width:" + (R.fixedWidth[e] || R.fixedWidth) + "vw;": (R.minWidth ? "min-width:" + (R.minWidth[e] || R.minWidth) + "vw;": "min-width:" + R.width + "vw;") + (R.maxWidth ? "max-width:" + (R.maxWidth[e] || R.maxWidth) + "vw;": "")) + '"><div class="dwwl dwwl' + e + (f.multiple ? " dwwms": "") + '">' + ("scroller" != R.mode ? '<div class="dwb-e dwwb dwwbp ' + (R.btnPlusClass || "") + '" style="height:' + Q + "vw;line-height:" + Q + 'vw;"><span>+</span></div><div class="dwb-e dwwb dwwbm ' + (R.btnMinusClass || "") + '" style="height:' + Q + "vw;line-height:" + Q + 'vw;"><span>&ndash;</span></div>': "") + '<div class="dwl">' + b + '</div><div tabindex="0" aria-live="off" aria-label="' + b + '" role="listbox" class="dwww"><div class="dww" style="height:' + R.rows * Q + 'vw;"><div class="dw-ul" style="margin-top:' + (f.multiple ? 0 : R.rows / 2 * Q - Q / 2) + 'vw;">',
                                            c += B(e) + '</div></div><div class="dwwo"></div></div><div class="dwwol"' + (R.selectedLineHeight ? ' style="height:' + Q + "vw;margin-top:-" + (Q / 2 + (R.selectedLineBorder || 0)) + 'vw;"': "") + "></div></div>" + (m ? "</div>": "</td>"),
                                            e++
                                    }),
